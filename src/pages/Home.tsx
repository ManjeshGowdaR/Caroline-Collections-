...
export function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section ref={heroRef} className="relative h-screen min-h-[600px] flex items-center">
        {/* Background Image */}
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-2xl text-white">
            ...
            <p className="animate-in text-lg md:text-xl text-gray-200 mb-8 leading-relaxed">
              Explore our curated collection of exquisite sarees and designer kurtis. 
              Handpicked for the modern Indian woman who values tradition.
            </p>
            <div className="animate-in flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/shop?saree">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white text-white hover:bg-white hover:text-[#2D5A4A] px-8 py-6 text-lg"
                >
                  View Sarees
                </Button>
              </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">Trending Styles</h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#7CB69D]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="h-8 w-8 text-[#2D5A4A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="relative group overflow-hidden rounded-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <p className="text-[#C9A86A] font-medium mb-2">Traditional Elegance</p>
                <h3 className="text-3xl font-serif font-bold text-white mb-4">
                  Exquisite Sarees
                </h3>
                <p className="text-gray-300 mb-6">
                  From Banarasi to Kanjeevaram, discover our premium saree collection
                </p>
                <Link to="/shop?saree">
            ...
            <div className="relative group overflow-hidden rounded-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1E3D31]/90 via-[#1E3D31]/30 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <p className="text-[#C9A86A] font-medium mb-2">Contemporary Style</p>
                <h3 className="text-3xl font-serif font-bold text-white mb-4">
                  Designer Kurtis
                </h3>
                <p className="text-gray-300 mb-6">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-[#7CB69D]">Handwoven elegance for every occasion</p>
            </div>
            <Link to="/shop?saree" className="hidden sm:flex items-center text-[#2D5A4A] font-medium hover:text-[#C9A86A] transition-colors">
              View All
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-[#7CB69D]">Comfort meets style in every stitch</p>
            </div>
            <Link to="/shop?kurti" className="hidden sm:flex items-center text-[#2D5A4A] font-medium hover:text-[#C9A86A] transition-colors">
              View All
              <ArrowRight className="ml-1 h-4 w-4" />
            </Link>
          </div>
